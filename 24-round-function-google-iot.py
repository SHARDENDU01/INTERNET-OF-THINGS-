...
GDOCS_OAUTH_JSON       = 'shard.json'
GDOCS_SPREADSHEET_NAME = 'shard'
...
while True:
    ...
    blight= b/10.23
    ###################################################
        # ROUND OFF FUNCTION IS INBUILT FUNCTION IN PYTHON.
    xtemp=round(atemp,2)
    xlight=round(blight,2)
...
#    print(time1)
    ...
    print blight
    try:
      worksheet.append_row((time1,temp1,hum1,xtemp,xlight))
      print "***************************************************"
